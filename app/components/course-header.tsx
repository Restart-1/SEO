    ...
    <>
      ...
      <header className="course-header">
        ...
        <div className="header-tools">
          <a className="agenda-link" href={sitePath('/agenda/')}><CalendarClock /> Agenda</a>
      ...
      <aside className={`course-drawer ${open ? 'open' : ''}`}>
        ...
        <a className={active === 'agenda' ? 'drawer-practice active' : 'drawer-practice'} href={sitePath('/agenda/')}><CalendarClock /> Agenda de 150 minutos</a>
        <nav>
