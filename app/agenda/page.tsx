...
export default function AgendaPage() {
  return <main className="restart-app"><CourseHeader active="agenda"/><section className="topics-page">
    <header className="topics-heading"><div><span>ÍNDICE DE LA PRESENTACIÓN</span><h1>Elige el tema o la <em>diapositiva.</em></h1><p>8 conceptos · 4 actividades resueltas · 32 páginas · sesión sugerida de 150 minutos</p></div></header>
