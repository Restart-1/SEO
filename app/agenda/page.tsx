...
const viewLabels = { idea: 'Idea', visual: 'Apoyo visual', example: 'Antes / Mejor', activity: 'Actividad', 'activity-example': 'Ejemplo resuelto' } as const;

export default function AgendaPage() {
  return <main className="restart-app"><CourseHeader active="agenda"/><section className="topics-page">
    <header className="topics-heading"><div><span>ÍNDICE DE LA PRESENTACIÓN</span><h1>Elige el tema o la <em>diapositiva.</em></h1><p>8 conceptos · 4 actividades resueltas · 32 páginas · sesión sugerida de 150 minutos</p></div><a href={sitePath('/notas-del-orador-seo-aeo.pdf')} download><Download/> Descargar guía detallada</a></header>
